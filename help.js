...
<h3>What's New (v2.4.14)</h3>
<ul>
  <li><strong>Wording fix</strong>: Corrected FTP terminology — etaHEN is the PS5 payload; the port-2121 listing fix isn't GoldHEN-specific (that's a PS4 tool). No behavior change.</li>
</ul>
...
<h3>v2.4.12</h3>
<ul>
  <li><strong>Port 2121 listing fix</strong>: Consoles whose FTP runs on port 2121 now scan correctly. Previously their folders showed as empty because that server's MLSD listing returns nothing — PS5 Vault now uses the plain LIST command, like FileZilla, so all your games are found.</li>
